...
import questions from "@/data/n5-kanji-reading-practice-2.json";
import Link from "next/link";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title:
    "JLPT N5 Kanji Quiz #3 | Free Reading Test (25 Questions)",
...
keywords: [
  ...
  alternates: {
    canonical:
      "https://kanjigami.com/practice/jlpt-n5-kanji-practice-3",
  },

  openGraph: {
    title:
      "JLPT N5 Kanji Practice 3 – Reading Quiz",
    description:
...
export default function JLPTN5KanjiPractice3Page() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "JLPT N5 Kanji Practice 3",
        item: "https://kanjigami.com/practice/jlpt-n5-kanji-practice-3",
      },
    ],
  };

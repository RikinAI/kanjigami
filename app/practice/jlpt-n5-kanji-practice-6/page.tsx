...
import questions from "@/data/n5-kanji-reading-selection-3.json";
import Link from "next/link";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title:
    "JLPT N5 Kanji Practice 6 – Choose the Correct Kanji | KanjiGami",
  ...
  alternates: {
    canonical:
      "https://kanjigami.com/practice/jlpt-n5-kanji-practice-6",
  },

  openGraph: {
    title:
      "JLPT N5 Kanji Practice 6 – Choose the Correct Kanji",
    description:
...
export default function JLPTN5KanjiPractice6Page() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "JLPT N5 Kanji Practice 6",
        item: "https://kanjigami.com/practice/jlpt-n5-kanji-practice-6",
      },
    ],
  };
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm md:text-base text-slate-600 leading-6">
            Master all 180 essential JLPT N4 Kanji with meanings, readings,

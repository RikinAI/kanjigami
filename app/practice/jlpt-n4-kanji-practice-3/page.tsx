...
import questions from "@/data/n4-kanji-reading-practice-2.json";
import Link from "next/link";
import type { Metadata } from "next";

export const metadata: Metadata = {
title:
    "JLPT N4 Kanji Quiz #3 | Free Reading Test (25 Questions)",
...
"Learn JLPT N4 Kanji"
  ...
  alternates: {
    canonical:
      "https://kanjigami.com/practice/jlpt-n4-kanji-practice-3",
  },

  openGraph: {
    title:
      "JLPT n4 Kanji Practice 3 – Reading Quiz",
    description:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "JLPT n4 Kanji Practice 3",
        item: "https://kanjigami.com/practice/jlpt-n4-kanji-practice-3",
      },
    ],
  };

...
import questions from "@/data/n5-kanji-reading-selection-1.json";
import Link from "next/link";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title:
    "JLPT N5 Kanji Practice 2 – Choose the Correct Kanji | KanjiGami",
  ...
  alternates: {
    canonical:
      "https://kanjigami.com/practice/jlpt-n5-kanji-practice-2",
  },

  openGraph: {
    title:
      "JLPT N5 Kanji Practice 2 – Choose the Correct Kanji",
    description:
...
export default function JLPTN5KanjiPractice2Page() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "JLPT N5 Kanji Practice 2",
        item: "https://kanjigami.com/practice/jlpt-n5-kanji-practice-2",
      },
    ],
  };

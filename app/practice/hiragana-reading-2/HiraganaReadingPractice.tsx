...
import words from "@/data/hiragana-practice-2.json";
...
<div id="score-card"  className="scroll-mt-32 mb-6 rounded-xl border border-slate-200 bg-white p-4 md:p-3 shadow-sm">

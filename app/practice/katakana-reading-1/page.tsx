...
export const metadata: Metadata = {
  title:
    "Katakana Reading Practice 1 – Japanese Vocabulary Quiz | KanjiGami",

  description:
    "Practice reading Katakana words with interactive quizzes. Learn common loanwords, improve your Japanese reading skills, and receive instant feedback.",
  ...
  alternates: {
    canonical:
      "https://kanjigami.com/practice/katakana-reading-1",
  },

  openGraph: {
    title:
      "Katakana Reading Practice 1 | KanjiGami",
    description:
      "Practice reading common Katakana words with interactive vocabulary quizzes.",
    url:
      "https://kanjigami.com/practice/katakana-reading-1",
    siteName: "KanjiGami",
    type: "website",
  ...
  twitter: {
    ...
    description:
      "Practice Katakana reading with common Japanese loanwords.",
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "Katakana Reading Practice 1",
      item: "https://kanjigami.com/practice/katakana-reading-1",
    },
  ],
};

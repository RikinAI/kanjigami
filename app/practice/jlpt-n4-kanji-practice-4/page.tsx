...
import questions from "@/data/n4-kanji-reading-selection-2.json";
import Link from "next/link";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title:
    "JLPT N4 Kanji Practice 4 – Choose the Correct Kanji | KanjiGami",
  ...
  alternates: {
    canonical:
      "https://kanjigami.com/practice/jlpt-n4-kanji-practice-4",
  },

  openGraph: {
    title:
      "JLPT n4 Kanji Practice 4 – Choose the Correct Kanji",
    description:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "JLPT n4 Kanji Practice 4",
        item: "https://kanjigami.com/practice/jlpt-n4-kanji-practice-4",
      },
    ],
  };
